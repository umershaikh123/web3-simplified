    ...
    <div className="h-[100vh] overflow-clip">
      ...
      <div className="w-full min-[900px]:flex-row flex flex-col">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white px-4 py-24 items-center justify-center flex flex-col min-[900px]:w-1/2 w-full space-y-4"
          id="section1"
        >
        ...
        <div className="flex flex-col min-[900px]:w-1/2 w-full">
          <motion.div
            ...
            transition={{ duration: 1, ease: "easeInOut" }}
            viewport={{ once: true }}
            className="bg-[var(--primary)] text-[var(--background)] px-4 py-24 flex flex-col items-center justify-center space-y-4"
            id="section2"
          >
          ...
          <motion.div
            ...
            transition={{ duration: 1, ease: "easeInOut" }}
            viewport={{ once: true }}
            className="bg-[var(--background)] text-white px-4 py-24 flex flex-col items-center justify-center space-y-4"
            id="section3"
          >
